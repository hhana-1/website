...
const tracks = [
  ...
  {
    name: "Lloraras",
    artist: "Óscar Emilio León Simosa",
    path: "/audio/Lloraras.mp3",
  },
   {
    name: "Morenita",
   ...
   {
    name: "La colegiala (original_version)",
    artist: "Rodolfo y su Tipica",
    path: "/audio/Rodolfo_y_su_Tipica_-_La_colegiala_(original_version).mp3",
  },
   {
    name: "Reggaeton Latino (Remix)",
    artist: "Don Omar ft. N.O.R.E., Fat Joe & LDA",
    path: "/audio/Don_Omar_-_Reggaeton_Latino_ft._N.O.R.E.,_Fat_Joe_&_LDA_(Remix).mp3",
  },
   {
    name: "Push Thru",
    artist: "The Grey Room _ Golden Palms",
    path: "/audio/Push Thru - The Grey Room_Golden_Palms.mp3",
  },
   {
    name: "Van Life Rager",
